...
export default function AdminSettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center p-40 text-center">
      ...
      <h1 className="text-3xl font-black text-primary uppercase">Site Configuration</h1>
      <p className="text-slate-400 font-medium">Coming soon: Global identity and API management.</p>
    </div>
  );
}
