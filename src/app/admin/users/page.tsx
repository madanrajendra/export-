...
export default function AdminUsersPage() {
  return (
    <div className="flex flex-col items-center justify-center p-40 text-center">
      ...
      <h1 className="text-3xl font-black text-primary uppercase">Identity Manager</h1>
      <p className="text-slate-400 font-medium">Coming soon: Role assignment and access control.</p>
    </div>
  );
}
